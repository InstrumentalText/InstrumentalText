...
public class TriggerAreaPromptExecutor : MonoBehaviour
{
    [Header("颜色设置")]
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Debug.Log("[TriggerArea] Handle 进入");
    ...
    private void ProcessPrompt()
    {
        ...
        if (textStore == null)
        {
            Debug.LogWarning("[TriggerArea] No CurrentTextStore on root.");
            return;
        }
        ...
        Debug.Log($"[TriggerArea] Prompt detected: {prompt}");
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            Debug.Log("[TriggerArea] Handle 离开");
